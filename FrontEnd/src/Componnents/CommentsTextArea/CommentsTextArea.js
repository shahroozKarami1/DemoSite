...
export default function CommentsTextArea(props) {
  let [commentData, setCommentData] = useState(props.commentsData);
  let [isEmpty, setIsEmpty] = useState(commentData);
  let [isShowTextArea, setIsShowTextArea] = useState(false);
  let [textAreaBody, setTextAreaBody] = useState("");
  ...
  return (
    <>
      <section className="commentArea">
        <main className="commentArea-wrap">
          <div className="commentArea-header">
            <div className="commentArea-header__right">
              <FaComments className="commentArea-header__right--icon" />
              <h1 className="commentArea-header__right--title">نظرات </h1>
            </div>
            <div className="commentArea-header__left">
              <button
                className="commentArea-header__left--btn"
                onClick={() => {
                  setIsShowTextArea(!isShowTextArea);
                }}
              >
                ایجاد نظر جدید
                <MdAddComment className="commentArea-header__left--btnIcon" />
              </button>
            </div>
          </div>
          ...
          {isShowTextArea ? (
            <>
              <div className="addComement-wrap">
                <div className="addComment-header">
                  <img src="" alt="profile" />
                  <div className="addComment-header__profile">
                    <h4 className="addComment-header__profile--name">
                      شهروز کرمی{" "}
                    </h4>
                    <span className="addComment-header__profile--subtitle">
                      ثبت نظر جدید
                    </span>
                  </div>
                </div>
                ...
                <div className="addComment-btns">
                  <button
                    className="addComment-btn_submit"
                    onClick={() => {
                        props.submitComment(textAreaBody)
                    }}
                  >
                    ارسال{" "}
                  </button>
                  <button
                    className="addComment-btn_reject"
                    onClick={() => setIsShowTextArea(false)}
                  >
                    لفو{" "}
                  </button>
                </div>
          ...
          <div className="commentArea-body">
            {isEmpty ? (
              commentData.map((data) => <CommentBox data={data}></CommentBox>)
            ) : (
              <div className="commentArea-body__empty">
                <svg
                  width="112"
                  height="100"
                  viewBox="0 0 112 100"
                ...
                <h1 className="commentArea-body__empty--desc">
                  {" "}
